...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-4">
    <a href="/guest/Adidas">
        <div class="border border-rounded text-white p-4 rounded">
            <img src="/image/adida.png" alt="">
        </div>
    </a>
    <a href="/guest/Nike">
        <div class="border border-rounded text-white p-4 rounded">
            <img src="/image/nikee.png" alt="">
        </div>
    </a>
    <a href="/guest/Converse">
        <div class="border border-rounded text-white p-4 rounded">
            <img src="/image/conversee.png" alt="">
        </div>
    </a>
    <a href="/guest/NewBalance">
        <div class="border border-rounded text-white p-4 rounded">
            <img src="/image/NBNB.png" alt="">
        </div>
    </a>
    <a href="/guest/OnitsukaTiger">
        <div class="border border-rounded text-white p-4 rounded">
            <img src="/image/onir.png" alt="">
        </div>
    </a>
    <a href="/guest/Vans">
        <div class="border border-rounded text-white p-4 rounded">
            <img src="/image/vanss.png" alt="">
        </div>
    </a>
</div>
