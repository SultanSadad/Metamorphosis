                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            @endif
                            <button class="btn btn-ghost btn-xs me-2 text-sm font-semibold text-blue-700 hover:text-blue-900" onclick="document.getElementById('modal_{{ $pembayaranItem->id_pembayaran }}').showModal()">
    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline-block align-text-bottom mr-1.5 -mt-1" viewBox="0 0 20 20" fill="currentColor">
        <path fill-rule="evenodd" d="M2 10a8 8 0 1116 0 8 8 0 01-16 0zm7-5a1 1 0 00-2 0v4a1 1 0 001 1h4a1 1 0 000-2h-3V5z" clip-rule="evenodd" />
    </svg>
    Detail Pesanan
</button>
